...
public class Player1 extends Player
{
    ...
    public Player1(int x, int y, int gX, int gY, boolean isUser) {
        super(x, y, gX, gY);
        this.isUser = isUser;
    }
        ...
        if(bg.currentTurn == 1) {
            if(isUser) {
                if(!isDragging && Greenfoot.mouseDragged(this)) {
                    isDragging = true;
                    Step newStep = new Step(1, new Coordinate(gridX, gridY), bg.board);
                ...
                if(Greenfoot.mouseDragEnded(this)) {
                    ...
                    if(a[0] == x && a[1] == y) { // move to the same point, doesn't count
                        ...
                        List<Player2> list2 = bg.getObjectsAt(a[0], a[1], Player2.class);
                        ...
                        bg.board.moveChecker(1, oldGX, oldGY, gridX, gridY);
